export const InstagramIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" height={30} width={30} xmlSpace="preserve" viewBox="0 0 16 16" id="instagram">
...
export const FacebookIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" height={30} width={30} viewBox="0 0 1024 1024" id="facebook">
